...
const StatusIcon = ({imageCssClass, height, width, type}) => {
        switch(type){     
            ...
            case "Fixed":
                return <svg height={height} width={width} className={imageCssClass} viewBox="0 0 100 125" enableBackground="new 0 0 100 100"><g transform="translate(11,0)"><polygon points="44.8,82.8 13.2,59.4 19.8,50.6 42.2,67.2 79,13.9 88,20.1 "/></g></svg>;
            case "Returned":
                return <svg height={height} width={width} className={imageCssClass} viewBox="0 0 100 125" enableBackground="new 0 0 100 100"><g transform="translate(11,-952.36218)"><path d="m 40.000001,975.36217 -31.9999995,25.00003 31.9999995,25 0,-12 c 1.7024,-0.08 31.377101,-2.0334 51.999998,16 -8.252997,-25.4273 -34.173798,-37.4872 -51.999998,-42.00003 z"/></g></svg>;
            case "Closed":
